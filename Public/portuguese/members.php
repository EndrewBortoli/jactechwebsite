...
<body>
	...
	<div class="form" style="border-radius: 20px; z-index: 0;">
		 ...
		 <br><br>
			...
			<input type="email" name="usuario" placeholder="Insert tou email:">
			<input type="password" name="senha" placeholder="Insert you password:">
			<button action="submit">Login</button>

			<div class="container" style="font-family: 'Montserrat'; font-size: 12px; margin-top: 10px; ">
			<br>
            <span class="psw">Forgot you password? <a class="link1" href="forgetpassword.php" style="font-weight: bolder; cursor:pointer;">Click here</a></span>
        </div> 
