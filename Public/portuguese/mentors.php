...
<head>
    ...
    <meta name="description" content="Estes são os nossos mentores e treinadores!">
    <meta name="author" content="Jactech">
    <meta name="keywords" content="Jactech, equipe, lar, robótica, treinadores, treinador, mentor, mentores, pessoas">
...
<body>
    ...
    <nav id="menu">
      ...
      <ul>
        ...
        <li><a href="#" class="hover-underline-animation">MENTORES</a></li> -->
        <li><a href="members.php" class="hover-underline-animation">MEMBROS</a></li>
            <div class="switch">
                <input id="language-toggle" class="check-toggle check-toggle-round-flat" type="checkbox" onchange="redirectPageMentors(this)">
